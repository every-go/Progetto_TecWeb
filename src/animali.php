<?php 
    ...
    require_once '.'.DIRECTORY_SEPARATOR.'utils'.DIRECTORY_SEPARATOR.'pagination.php';
    use DB\DBAccess;
    ...
    if($connessioneOK){
        ...
        //     }
            ...
            $content = str_replace('[LISTA_PAGINE]', createPaginationLinks($paginaCorrente, $totalePagine, $baseURL), $content);
