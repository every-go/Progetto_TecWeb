...
Sul verde scuro (1B4332) vengono utilizzati come colori del testo il beige (FAF3DD, rapporto 9.98:1) e il giallo(FFD166, rapporto 7.68:1) nella navbar per differenziare i link visitati dai link non visitati.
...
Un test effettuato molto spesso è l'utilizzo di NVDA alla fine della scrittura o modifica di una pagina, in modo da permetterci di capire come sta proseguendo la scrittura in termini di accessibilità tramite screen reader.

== Test TotalValidator

Quando possibile è stato utilizzato TotalValidator in modo da continuare a controllare che il progetto stesse andando nella direzione giusta.
