...
#table(
  ...
  [Login],[Login, Utente],[Qui le due keyword aggiuntive erano implicite dal significato della pagina, poiché un utente può ricercare la pagina di login per diventare un "utente" di Casa Otium],
