...
#figure()[
  ...
  #terms(
    ...
    ([Marco Brunello],[
      #columns()[
        ...
        *HTML*: Scrittura di gran parte delle pagine
        ...
        #emph("Minor") \
        *Altro*: Gestione e reperimento delle immagini statiche
    ...
    ([Davide Lorenzon],[
      #columns()[
        #emph("Major") \
        *Php*: Sviluppo di feature legate a funzioni e classi helper, comunicazioni col database, gestione delle immagini lato backend
        #colbreak()
